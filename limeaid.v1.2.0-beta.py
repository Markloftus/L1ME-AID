...
def repeatmaskerPatternFilter(df):
    ...
    for row in df2.index:
        if df2.at[row,'TE_Proportion'] == 'NONE':
            ...
            temporaryHitList = ast.literal_eval(str(df2.at[row,'TE_Hits']))
...
def main():
	...
	processing_functions = [cleanDataTEPercentage, orientationFinder, tailCounter, aluLinker, tailCounterCheck, finalQuickCheck, finalQuickCheck2, repeatmaskerPatternFilter, findTwinPriming, simpleRepeatCheck]
